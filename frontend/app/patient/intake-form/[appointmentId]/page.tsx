...
import type { IntakeFormTemplate, IntakeFormField, IntakeFormSubmissionField } from '@/types'
import {
  getActiveIntakeFormTemplate
...
export default function PatientIntakeFormPage() {
  ...
  const { currentAppointment } = useSelector((state: RootState) => state.patientPortal)
  ...
  const validateCurrentSection = (): boolean => {
    ...
    currentSection.fields.forEach(field => {
      ...
      if (field.conditionalLogic?.enabled && field.conditionalLogic.dependsOn) {
        ...
        if (field.conditionalLogic.condition === 'equals' && 
